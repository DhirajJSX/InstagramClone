...
function LeftSidebar() {
  return (
    <aside className="w-full lg:max-w-[250px] dark:border-gray-600 rounded-r-3xl bg-[#0e0e0e] text-white border-r p-4 pb-6 hidden lg:flex flex-col justify-between lg:sticky lg:top-0 lg:h-screen overflow-y-auto">
